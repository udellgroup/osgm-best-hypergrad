...
# Load the dataset
from def_problems import get_cutest_problem
...
if __name__ == "__main__":
    ...
    reg = 0.0
    L_est, n, fval, grad, x0, dataset = get_cutest_problem(prob_i=dataid)
    
    print(f"Problem: {dataset}")
    print(f"Number of variables: {n}")
    # print(f"Estimated Lipschitz constant: {L_est}")
    ...
    hdm_params[ALG_HDM_NONCONVEX] = True
    ...
    opt_val = stats_bench[ALG_STATS_OPTIMAL_VALUE] - 1e-12
