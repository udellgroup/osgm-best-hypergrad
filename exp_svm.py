...
if __name__ == "__main__":
    ...
    alg_list = {
        ...
        "HDM-Best": [HyperGradientDescent, hdm_param_base, hdm_search_grid],
    }
    ...
    opt_val = np.min([alg_list[algo][4][ALG_STATS_OPTIMAL_VALUE] for algo in alg_list.keys()])
    opt_val = opt_val - 1e-10
